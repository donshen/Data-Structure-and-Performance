...
public class AutoCompleteDictionaryTrie implements  Dictionary, AutoComplete {
	...
	{
	    // TODO: Implement this method
		String wordCandidate = s.toLowerCase();
		TrieNode node = root;
     ...
     */@Override
     public List<String> predictCompletions(String prefix, int numCompletions) 
     {
    	 ...
    	 //    Create a queue (LinkedList)7dd the node that completes the stem to the back
    	 //       of the list.
    	 ...
    	 while (!q.isEmpty() && completed.size() < numCompletions) {
    		 TrieNode curr = q.poll();
    		 if (curr.endsWord()) {
    			 completed.add(curr.getText());
    		 }
    		 
    		 List<Character> childNodes = new LinkedList<Character>(curr.getValidNextCharacters());
