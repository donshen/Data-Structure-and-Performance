...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
		...
		// You can play around with this.
		int start = 50000;
		System.out.println("NumberOfChars \t BasicTime \t Efficient Time");
				...
				numToCheck += increment)
		{
			 ...
			 */  
			 ...
			 BasicDocument docBasic = new BasicDocument(text);
			 double resultBasic = docBasic.getFleschScore();
			 long endTimeBasic = System.nanoTime();
			 //System.out.print((endTimeBasic-startTimeBasic)/1000000000 + '\t');
			 long startTimeEfficient = System.nanoTime();
			 EfficientDocument docEfficient = new EfficientDocument(text);
			 double resultEfficient = docEfficient.getFleschScore();
			 long endTimeEfficient = System.nanoTime();
			 System.out.println(numToCheck + "\t" +
					 (endTimeBasic-startTimeBasic)/1000000000.0 + "\t" +
					 (endTimeEfficient-startTimeEfficient)/1000000000.0);
