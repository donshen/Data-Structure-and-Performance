...
public abstract class Document {
	 ...
	 */
	protected boolean isVowel(char currLett) 
	{
		boolean isVow = false;
		if (currLett == 'a' || currLett == 'e'|| currLett == 'i'|| currLett == 'o'
				|| currLett == 'u'|| currLett == 'y') 
		{
			isVow = true;
		}
		return isVow;
...
//					// ... and skip consecutive vowel(s)
//						syllableCount ++;
//						while (isVowel(currLett) && i < word.length() - 1) {
//							i ++;
//							currLett = word.charAt(i);
//						}
//					}
//				} else {
//			  
